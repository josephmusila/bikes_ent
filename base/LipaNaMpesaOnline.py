...
def sendSTK(bike,phone_number, amount, orderId=0, transaction_id=None, shortcode=None, account_number=None):
    ...
    if json_response.get('ResponseCode'):
        if json_response["ResponseCode"] == "0":
            ...
            if transaction_id:
                ...
                transaction = PaymentTransaction.objects.create(bike=bike,phone_number=phone_number,
